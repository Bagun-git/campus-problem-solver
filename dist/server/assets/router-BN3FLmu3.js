...
const appCss = "/assets/styles-CpqziSV9.css";
...
const AuthCtx = reactExports.createContext({ user: null, session: null, isAdmin: false, loading: true, signOut: async () => {
} });
function AuthProvider({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AuthCtx.Provider, { value: { user: session?.user ?? null, session, isAdmin, loading, signOut }, children });
}
const useAuth = () => reactExports.useContext(AuthCtx);
const logo = "/assets/logo-d7dYpSim.png";
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "border-b bg-background/95 backdrop-blur sticky top-0 z-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto flex items-center justify-between px-4 py-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "Campus Problem Solver", className: "h-10 w-10 rounded-full object-contain" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-lg hidden sm:inline", children: "Campus Problem Solver" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-base sm:hidden", children: "CPSP" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex items-center gap-4 sm:gap-6 text-sm font-medium", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "text-primary hover:underline", children: "Home" }),
      !user ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/login", className: "text-primary hover:underline", children: "Login" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/register", className: "text-primary hover:underline", children: "Register" })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/dashboard", className: "text-primary hover:underline", children: "Dashboard" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/profile", className: "text-primary hover:underline", children: "Profile" }),
        isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/admin", className: "text-primary hover:underline", children: "Admin" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleLogout, className: "text-primary hover:underline", children: "Logout" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "h-6 w-6 text-foreground/70" })
    ] })
  ] }) });
}
...
const Route$6 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Campus Problem Solver — Raise & Track Campus Complaints" },
      { name: "description", content: "Submit, track, and resolve campus complaints — cleanliness, WiFi, hostel, academics and more." },
      { property: "og:title", content: "Campus Problem Solver" },
      { property: "og:description", content: "Raise complaints easily and track them efficiently." },
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AuthProvider, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "border-t py-6 text-center text-sm text-muted-foreground", children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Campus Problem Solver — Built for students & faculty"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster, { position: "top-right", richColors: true })
  ] }) });
}
const $$splitComponentImporter$5 = () => import("./register-CrKOeKCx.js");
const Route$5 = createFileRoute("/register")({
  head: () => ({
    meta: [{
      title: "Register — Campus Problem Solver"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./profile-kEU7BMAl.js");
const Route$4 = createFileRoute("/profile")({
  head: () => ({
    meta: [{
      title: "Profile — Campus Problem Solver"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./login-qrb5kuad.js");
const Route$3 = createFileRoute("/login")({
  head: () => ({
    meta: [{
      title: "Login — Campus Problem Solver"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./dashboard-Cctn_r8i.js");
const Route$2 = createFileRoute("/dashboard")({
  head: () => ({
    meta: [{
      title: "Dashboard — Campus Problem Solver"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./admin-Ce_q0P7X.js");
const Route$1 = createFileRoute("/admin")({
  head: () => ({
    meta: [{
      title: "Admin — Campus Problem Solver"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-D7WVitbC.js");
