...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-d-j3Apn4.js");
...
const manifest = {
  "27301031363e284184ead21ac910c33ebfbe9159435c975f26319c6a65fade88": {
    ...
    importer: () => import("./account.functions-DEn-HysJ.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BN3FLmu3.js").then((n2) => n2.r),
    import("./start-BhvbBUGE.js"),
